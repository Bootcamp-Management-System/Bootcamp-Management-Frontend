  ...
  return (
    <div className="max-w-7xl mx-auto">
      <header className="mb-10">
        <h2 className="text-3xl font-bold mb-2 text-white">Admin Control Center</h2>
      ...
      <div className="bg-portal-card border border-portal-border rounded-2xl p-8 shadow-xl">
        <div className="flex justify-between items-center mb-8">
          ...
          <button className="text-sm font-bold text-portal-text-muted hover:text-white transition-colors">View All Audit Logs</button>
        </div>
