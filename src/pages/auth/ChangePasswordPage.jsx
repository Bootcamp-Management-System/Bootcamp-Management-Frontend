    ...
    <div className="min-h-screen flex items-center justify-center bg-portal-bg relative overflow-hidden p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-portal-text-muted mt-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <label className="block text-sm font-medium text-portal-text ml-2">
              New Password
            </label>
          ...
          <div className="bg-portal-input rounded-xl p-4 space-y-2 border border-portal-border">
            <p className="text-[10px] font-bold text-portal-text-muted uppercase tracking-widest mb-1">
              Requirements
            </p>
            <div className="flex items-center gap-2 text-xs text-portal-text-muted">
              <CheckCircle2
                className={`w-3 h-3 ${password.length >= 8 ? "text-portal-accent" : "text-white/20"}`}
              />
              At least 8 characters
            </div>
            <div className="flex items-center gap-2 text-xs text-portal-text-muted">
              <CheckCircle2
                className={`w-3 h-3 ${password === confirmPassword && password !== "" ? "text-portal-accent" : "text-white/20"}`}
              />
              Passwords match
            </div>
          </div>
