...
import { Search, Filter, Mail, ShieldAlert, GraduationCap, ArrowUpCircle, UserPlus, BookOpen, BarChart3, MoreVertical } from 'lucide-react';
...
export const mockUsers = [
  ...
  { id: 3, name: 'Charlie Brown', email: 'charlie@example.com', role: 'Admin', divisions: ['Development'], year: 'All', status: 'Active' },
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-[#57606a] dark:text-[#8b949e]">Manage all students, instructors, and admins across the system.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          { role: 'Student', label: 'Total Students', count: 1284, icon: BookOpen, color: 'border-[#0969da] dark:border-[#58a6ff]', bg: 'bg-[#ddf4ff] dark:bg-[#051d4d]', text: 'text-[#0969da] dark:text-[#58a6ff]' },
          { role: 'Instructor', label: 'Total Instructors', count: 42, icon: GraduationCap, color: 'border-[#8250df] dark:border-[#d2a8ff]', bg: 'bg-[#f4ecff] dark:bg-[#3c1e70]', text: 'text-[#8250df] dark:text-[#d2a8ff]' },
          { role: 'Admin', label: 'Total Admins', count: 8, icon: ShieldAlert, color: 'border-[#cf222e] dark:border-[#ff7b72]', bg: 'bg-[#ffebe9] dark:bg-[#490202]', text: 'text-[#cf222e] dark:text-[#ff7b72]' }
        ].map((stat) => (
          <div 
            key={stat.role}
