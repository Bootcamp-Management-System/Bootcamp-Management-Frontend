  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 pb-10">
      <header className="flex items-center justify-between">
        ...
        <button className="flex items-center gap-2 bg-white/5 border border-portal-border px-6 py-2.5 rounded-xl text-sm font-bold text-portal-text hover:bg-white/10 transition-all">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-portal-card/50 border border-portal-border rounded-2xl p-6">
             ...
             <div className="text-2xl font-black text-portal-text mt-2">94.8%</div>
          ...
          <div className="bg-portal-card/50 border border-portal-border rounded-2xl p-6">
             ...
             <div className="text-2xl font-black text-portal-text mt-2">62%</div>
          ...
          <div className="bg-portal-card/50 border border-portal-border rounded-2xl p-6">
             ...
             <div className="text-2xl font-black text-portal-text mt-2">1.2%</div>
             <div className="flex items-center gap-1 text-[10px] text-green-400 mt-1">
