  ...
  return (
    <div className="max-w-7xl mx-auto space-y-10 pb-10">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h2 className="text-4xl font-black mb-2 text-portal-text tracking-tight uppercase">
            {currentDivision === 'All' ? 'Instructor Cohort' : `${currentDivision} Instructors`}
          </h2>
          <p className="text-sm font-black text-portal-text-muted uppercase tracking-[0.2em]">Domain experts managing the {currentDivision === 'All' ? 'system-wide' : `${currentDivision}`} curriculum.</p>
        </div>
        <button 
      ...
      <div className="bg-portal-card border border-portal-border rounded-[2.5rem] overflow-hidden shadow-2xl relative">
        <DataTable 
          ...
          data={instructors} 
          actions={actions}
          searchPlaceholder="Filter instructors by name or email..."
        />
        <Award className="absolute -right-10 -bottom-10 w-64 h-64 text-portal-accent/[0.03] -rotate-12 pointer-events-none" />
      </div>
